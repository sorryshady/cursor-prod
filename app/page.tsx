...
import { StateCommitteeCarousel } from "@/components/committee/state-committee-carousel";
...
export default function HomePage() {
  return (
    <>
      ...
      <section className="bg-gradient-to-b from-[#5386A4]/100 to-[#1F333E]/100 z-20">
        <Wrapper className="relative z-10 space-y-10 py-12">
          <PageHeader
